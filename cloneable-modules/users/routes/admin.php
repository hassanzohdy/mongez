...
*/
Route::post('/login', 'Modules\Users\Controllers\Admin\Auth\LoginController@index')->middleware('auth');
Route::get('/logout', 'Modules\Users\Controllers\Admin\Auth\LogoutController@index');

Route::group([
    'namespace' => 'Modules\Users\Controllers\Admin',
    'middleware' => ['auth','logged-in', 'check-permission'], // this middleware is used to check if user/admin is logged in
], function () {
